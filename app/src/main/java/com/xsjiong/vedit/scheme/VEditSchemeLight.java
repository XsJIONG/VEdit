...
public class VEditSchemeLight extends VEditScheme {
	private static VEditSchemeLight INSTANCE;

	public static VEditSchemeLight getInstance() {
		if (INSTANCE == null) INSTANCE = new VEditSchemeLight();
		return INSTANCE;
	}

	private VEditSchemeLight() {
